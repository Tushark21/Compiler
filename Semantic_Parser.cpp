...
int stackSize = 100000, top = -1;
vector<string> parseStack(100000);
...
*/
    ...
    //Enter Productions
    int no;
    cout<<"Enter Number of productions to be inserted:\n";
    cin>>no;
    cout<<"Enter Productions (seprate left and right of production with space):\n";
    while(no--){
        cin>>lhs1>>rhs1;
        rhs1=rhs1+",$";
        lhs.push_back(lhs1);
    ...
    string ter,nTer;
    cout<<"Enter Number of Terminals to be inserted:\n";
    cin>>no;
    cout<<"Enter Terminals:\n";
    while(no--){
        cin>>ter;
        terminals.push_back(ter);
    }

    cout<<"Enter Number of Non-Terminals to be inserted:\n";
    cin>>no;
    cout<<"Enter Non-Terminals:\n";
    while(no--){
        cin>>nTer;
        nonTerminals.push_back(nTer);
    }
...
//push and pop function definition
void pop() {
    if (top < 0) {
        cout << "Underflow\n";
    }
